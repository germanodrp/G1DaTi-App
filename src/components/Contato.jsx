  ...
  return (
    <section className="home">
      <div className="homeContato">
        ...
        <p className="DescricaoContato">Sou estudante na Uniaraxá,em Sistemas de Informações.<br/>
        Tenho 21 Anos,Atualmente estou no 6 período e trabalhando de estagiário de Back-End na Bit Pagg.
            </p>  
         <br/>
          ...
          <h3 className="RedesSociais"><Link >linkedin.com/in/germano-pereira-b098331b8</Link></h3>
          <br />
          <p className="SubTitulos">GitHub:</p>
          <h3 className="RedesSociais"><Link >https://github.com/germanodrp</Link></h3>
